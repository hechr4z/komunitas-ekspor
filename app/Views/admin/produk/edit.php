        ...
        <div class="row g-4 settings-section">
            <div class="col-12 col-md-8">
                <div class="app-card app-card-settings shadow-sm p-4">
                    <div class="card-body">
                        <form action="<?= base_url('admin-update-produk/' . $produk['id_produk']) ?>" method="post"
                                ...
                                <select class="form-select" id="id_member" name="id_member" required>
                                    ...
                                    <?php foreach ($member as $item): ?>
                                        <option value="<?= $item['id_member'] ?>"
                                            <?= ($item['id_member'] == $produk['id_member']) ? 'selected' : '' ?>>
                                            <?= $item['username'] ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <img id="preview" src="<?= base_url('img/' . $produk['foto_produk']) ?>"
                                    alt="Foto Produk" class="img-thumbnail mt-2" style="max-width: 100px;">
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Nama Produk</label>
                                <input type="text" class="form-control" value="<?= $produk['nama_produk'] ?>"
                                    name="nama_produk" value="Masukkan Nama Produk" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Nama Produk En</label>
                                <input type="text" class="form-control" value="<?= $produk['nama_produk_en'] ?>"
                                    name="nama_produk_en" value="Masukkan Nama Produk Versi Bahasa Inggris" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" style="height: 200px;" id="deskripsi_produk_en"
                                    ...
                                    placeholder="Masukkan Deskripsi Produk Versi Bahasa Inggris"><?= $produk['deskripsi_produk_en'] ?></textarea>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">HS Code</label>
                                <input type="text" class="form-control" value="<?= $produk['hs_code'] ?>" name="hs_code"
                                    required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Minimum Order</label>
                                <input type="number" class="form-control" value="<?= $produk['minimum_order_qty'] ?>"
                                    name="minimum_order_qty" value="100" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Kapasitas Produksi Per Bulan</label>
                                <input type="number" class="form-control"
                                    value="<?= $produk['kapasitas_produksi_bln'] ?>" name="kapasitas_produksi_bln"
                                    required>
                            </div>
