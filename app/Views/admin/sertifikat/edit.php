        ...
        <div class="row g-4 settings-section">
            <div class="col-12 col-md-8">
                <div class="app-card app-card-settings shadow-sm p-4">
                    <div class="card-body">
                        <form action="<?= base_url('admin-update-sertifikat/' . $sertifikat['id_sertifikat']) ?>" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="id_member" name="id_member" required>
                                    ...
                                    <?php foreach ($member as $item) : ?>
                                        <option value="<?= $item['id_member'] ?>" <?= ($item['id_member'] == $sertifikat['id_member']) ? 'selected' : '' ?>>
                                            <?= $item['username'] ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="sertifikat" name="sertifikat" accept="image/*,application/pdf">
