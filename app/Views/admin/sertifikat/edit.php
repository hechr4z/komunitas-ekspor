...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <h1 class="app-page-title" style="color: #03AADE;">Ubah Sertifikat</h1>
        <hr class="mb-4">
                        ...
                        <form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="sertifikat" name="sertifikat"
                                    accept="image/*,application/pdf" onchange="previewFile()" required>
                            </div>
                            <div class="mb-3">
                                <img id="preview" src="#" alt="Preview Sertifikat"
