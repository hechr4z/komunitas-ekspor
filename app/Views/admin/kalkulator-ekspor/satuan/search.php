...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            ...
            <div class="col-auto">
                <a href="<?= base_url('admin-add-satuan') ?>" class="btn text-white" style="background-color: #03AADE;"> + Tambah Data Satuan</a>
            </div>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table app-table-hover table-bordered mb-0 text-left">
                                ...
                                <?php if (empty($hasilPencarian)): ?>
                                    <tbody>
                                        <tr>
                                            <td colspan="4" class="text-center">Tidak ada Satuan yang ditemukan.</td>
                                        </tr>
                                    </tbody>
                            </table>
                        <?php else: ?>
