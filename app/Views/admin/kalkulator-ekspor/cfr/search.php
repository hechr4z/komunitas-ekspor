...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0" style="color: #03AADE;">List CFR</h1>
            </div>

            <!-- Tengahkan form search -->
            <div class="col d-flex justify-content-center">
                <form class="form" action="<?= base_url('admin-search-cfr') ?>" method="GET">
                    <label for="search">
                        <input required="" autocomplete="off" placeholder="cari cfr" name="keyword" id="keyword" type="text">
                        <div class="icon">
            ...
            <div class="col-auto">
                <a href="<?= base_url('admin-add-cfr') ?>" class="btn text-white" style="background-color: #03AADE;"> + Tambah Data CFR</a>
            </div>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table app-table-hover table-bordered mb-0 text-left">
                                ...
                                <?php if (empty($hasilPencarian)): ?>
                                    <tbody>
                                        <tr>
                                            <td colspan="7" class="text-center">Tidak ada CFR yang ditemukan.</td>
                                        </tr>
                                    </tbody>
                            </table>
                        <?php else: ?>
                            <tbody>
                                ...
                                <?php foreach ($hasilPencarian as $item) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center" valign="middle"><?= $item['komponen_cfr'] ?></td>
                                        <td class="text-center align-middle">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <a href="<?= base_url('admin-delete-cfr/' . $item['id_cfr']) ?>" class="btn btn-sm text-white me-2" style="background-color: #F2BF02;">
                                                    Hapus
                                                </a>
                                                <a href="<?= base_url('admin-edit-cfr/' . $item['id_cfr']) ?>" class="btn btn-sm text-white" style="background-color: #03AADE;">
                                                    Ubah
                                                </a>
                                            </div>
                                        </td>
