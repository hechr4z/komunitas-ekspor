...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0" style="color: #03AADE;">CFR</h1>
            </div>

            <div class="col-auto">
                <a href="/admin-add-cfr" class="btn text-white" style="background-color: #03AADE;">
                    + Tambah Komponen CFR
                            ...
                            <table class="table app-table-hover table-bordered mb-0 text-left">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center" valign="middle">Contoh Komponen CFR</td>
                                        <td class="text-center align-middle">
                                            <div class="d-flex justify-content-center align-items-center">
                                                ...
                                                <a href="/admin-edit-cfr" class="btn btn-sm text-white"
