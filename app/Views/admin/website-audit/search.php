...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0" style="color: #03AADE;">List Website Audit</h1>
            </div>

            <!-- Tengahkan form search -->
            <div class="col d-flex justify-content-center">
                <form class="form" action="<?= base_url('admin-search-website-audit') ?>" method="GET">
                    <label for="search">
                        <input required="" autocomplete="off" placeholder="cari website audit" name="keyword" id="keyword" type="text">
                        <div class="icon">
                        ...
                        <div class="table-responsive">
                            <table class="table app-table-hover table-bordered mb-0 text-left">
                                ...
                                <?php if (empty($hasilPencarian)): ?>
                                    <tbody>
                                        <tr>
                                            <td colspan="7" class="text-center">Tidak ada Website Audit yang ditemukan.</td>
                                        </tr>
                                    </tbody>
                            </table>
                        <?php else: ?>
