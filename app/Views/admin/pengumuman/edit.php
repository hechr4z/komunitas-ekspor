                    ...
                    <div class="card-body">
                        <form action="<?= base_url('/admin-update-pengumuman/' . $pengumuman['id_pengumuman']) ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" class="form-control" id="start_date" name="start_date" value="<?= esc($pengumuman['start_date']); ?>" required>
                            </div>

                            <div class="mb-3">
                                <label for="end_date" class="form-label">Tanggal Berakhir</label>
                                <input type="datetime-local" class="form-control" id="end_date" name="end_date" value="<?= esc($pengumuman['end_date']); ?>" required>
                            </div>
