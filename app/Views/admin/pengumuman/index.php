...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-0" style="color: #03AADE;">Pengumuman</h1>
            </div>
            ...
            <div class="col d-flex justify-content-center">
                <form class="form" action="#" method="GET">
                    <label for="search">
                        <input required="" autocomplete="off" placeholder="cari Pengumuman" name="keyword" id="keyword" type="text">
                        <div class="icon">
            ...
            <div class="col-auto">
                <a href="<?= base_url('/admin-add-pengumuman') ?>" class="btn text-white" style="background-color: #03AADE;"> + Tambah Pengumuman</a>
            </div>
        </div>
