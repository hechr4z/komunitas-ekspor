...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <h1 class="app-page-title" style="color: #03AADE;">Ubah MPM</h1>
        <hr class="mb-4">
                    ...
                    <div class="card-body">
                        <form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="tanggal_kirim_email" value="2023-10-10"
                                    required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Update Terakhir</label>
                                <input type="date" class="form-control" name="update_terakhir" value="2023-10-11"
                                    required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Nama Perusahaan</label>
                                <input type="text" class="form-control" name="nama_perusahaan" value="PT Contoh Abadi"
                                    required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="negara_perusahaan" name="negara_perusahaan" required>
                                    <option value="" disabled>Pilih Negara Perusahaan</option>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="status_progress" name="status_progress" required>
                                    <option value="" disabled>Pilih Status Progress</option>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="progres-editor"
                                    name="progres">Progress saya sudah mengirimkan email ke perusahaan Satuduatiga</textarea>
                            </div>
