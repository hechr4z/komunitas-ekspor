        ...
        <div class="card p-4 shadow-sm">
            ...
            <div class="tab-content mt-4" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="tambah-progres" role="tabpanel"
                    ...
                    <form action="<?= base_url('/mpm-add-premium'); ?>" method="POST" enctype="multipart/form-data" class="col-md-6 mx-auto">
                        <!-- Tanggal Kirim Email -->
                        <div class="mb-3">
                ...
                <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form id="editForm" action="<?= base_url('/mpm-edit-premium'); ?>" method="POST" enctype="multipart/form-data">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function generateDates(month, year) {
            ...
            fetch(`/mpm-premium/getEmailsByDate/${month}/${year}`)
                .then(response => response.json())
                .then(data => {
