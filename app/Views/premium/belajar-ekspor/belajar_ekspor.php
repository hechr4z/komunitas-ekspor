...
<div class="artikel-detail-section py-5" style="text-align: center;">
    ...
    <!-- Search Bar Start -->
    <form class="form mt-4" action="<?= base_url('premium-belajar-ekspor/search') ?>" method="GET">
        <button type="submit">
                ...
                <div class="submenu">
                    ...
                    <?php if (!empty($kategori_belajar_ekspor)): ?>
                        ...
                        <div class="submenu-item">
                            <a href="<?= base_url('premium-belajar-ekspor'); ?>" class="submenu-link <?= empty($active_category) ? 'active' : ''; ?>">
                                Semua Kategori
                            </a>
                        </div>
                        <!-- Loop kategori -->
                        <?php foreach ($kategori_belajar_ekspor as $item): ?>
                            <div class="submenu-item">
                                <a href="<?= base_url('premium-kategori/' . $item['slug']); ?>" class="submenu-link <?= $active_category == $item['id_kategori_belajar_ekspor'] ? 'active' : ''; ?>">
                                    <?= $item['nama_kategori']; ?>
                                </a>
                            </div>
                        <?php endforeach; ?>
