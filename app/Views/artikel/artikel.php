...
<div class="pendaftaran-section py-5" style="text-align: center;">
    ...
    <p class="text-custom-paragraph">Gali potensi yang selama ini kamu yakini bersama mentor yang ahli dibidangnya,
        <br>kamu bakal dipandu sampai bener bener paham.
    </p>
    <!-- Search Bar Start -->
    <form class="form">
        <button>
                ...
                <div class="card h-80">
                    ...
                    <div class="card-body d-flex flex-column">
                        <div class="mb-3 d-flex justify-content-between align-items-center">
                            <p class="card-text text-primary mb-0" style="font-size: 1rem;">19 Juli 2024</p>
                        ...
                        <a href="#" class="btn btn-primary mt-auto" style="width: 100%; display: block; text-align: center;">Baca Selengkapnya</a>
                    </div>
                </div>
            </div>
